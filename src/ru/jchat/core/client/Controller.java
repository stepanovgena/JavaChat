...
public class Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        disconnectByTimer(); //отключаем пользователя, если он не успел авторизоваться
    }
    ...
    /**
     * Метод отключения сокета по таймауту, если не успели авторизоваться
     */
                ...
                public void run() {
                    ...
                    if (authorized == false) {
                        try {
                            socket.close();
                            //System.exit(0);
                            showAlert("Вы не успели авторизоваться");
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
